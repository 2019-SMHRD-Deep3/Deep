...
<body class="is-preload">
	...
	<div id="wrapper" position=relative;>
		...
		<header id="header">
			<nav>
				<ul class="cont">
					<li><a style="font-size: 20px;" class="linkcolor" href="#intro">服务专区</a></li>
					<li><a style="font-size: 20px;" class="linkcolor" href="#work">地标</a></li>
					<li><a style="font-size: 20px;" class="linkcolor" href="#about">课程清单</a></li>
					<li><a style="font-size: 20px;" class="linkcolor" href="K-survey.jsp">课程推荐</a></li>
...
print 'It took ' + i + ' iterations to sort the deck.';</code>
	...
	<p id="texttext1">景福宫是代表大韩民国的最大宫殿，并有助于朝鲜王朝的繁荣。
	...
	<p id="texttext3">仁寺洞Ssamji-gil是首尔钟路区仁寺洞的一栋建筑物。
	...
	<p id="texttext6">奉恩寺有些不熟悉，没有寺庙，到处都是在平日和节假日不停祈祷和崇拜的人。宗教与日常生活息息相关，但对于那些想要静静地游览寺庙的人来说，宗教也不太好。这是一个很多人经常祈祷的地方，因此需要增加设施和空间，因此奉恩寺一直在建设中。奉恩寺是在新罗安那尔国王的王墓中建造的，后来成为已故朝鲜国王忠贤的寺庙。通常，我们所知道的寺庙都在人们不居住的山区或普通百姓生活的半径范围之外，奉恩寺位于首尔的中部。方便地，许多外国宗教人士也曾经访问过韩国。</p>
	<p id="texttext7">63大厦是韩国最高的建筑，代表着首尔，直到乐天塔竣工为止，现已成为首尔的地标建筑，由韩国公司Hanwha于1985年竣工。当时，韩国没有摩天大楼。
	...
	<p id="texttext8">1950年6月25日，每个人都在黎明前入睡。在和平的朝鲜半岛上开枪
	...
	<p id="texttext10">我们历史上的珍贵文物找到了一个美好的新家。 2005年10月开业
