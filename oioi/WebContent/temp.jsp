   ...
   <div>
      <table border=1px solid black>
         ...
         <tr>
            <td>숙박시설 취향</td>
            <td>
            게스트하우스/호스텔 <input type="radio" value="게스트하우스/호스텔" name="stay" id="stay">
            기타 <input type="radio" value="기타" name="stay" id="stay">
            모텔/여관 <input type="radio" value="모텔/여관" name="stay" id="stay">
            민박·공유숙박 <input type="radio" value="민박·공유숙박" name="stay" id="stay">
            친척또는친구집<input type="radio" value="친척또는친구집" name="stay" id="stay">
            콘도,펜션,레지던스인 <input type="radio" value="콘도,펜션,레지던스인" name="stay" id="stay">
            학교/회사기숙사,연수원 <input type="radio" value="학교/회사기숙사,연수원" name="stay" id="stay">
            호텔 <input type="radio" value="호텔" name="stay" id="stay">
            </td>
         </tr>
         <tr>
            <td>좋아하는 활동</td>
            <td>
            고궁/역사유적지방문 <input type="radio" value="고궁/역사유적지방문" name="act" id="act">
            공연,민속,행사,축제관람및참가 <input type="radio" value="공연,민속,행사,축제관람및참가" name="act" id="act">
            기타 <input type="radio" value="기타" name="act" id="act">
            놀이공원/테마파크 <input type="radio" value="놀이공원/테마파크" name="act" id="act">
            드라마/영화촬영지방문 <input type="radio" value="드라마/영화촬영지방문" name="act" id="act">
            레포츠활동 <input type="radio" value="레포츠활동" name="act" id="act">
            박물관,전시관방문 <input type="radio" value="박물관,전시관방문" name="act" id="act">
            뷰티관광 <input type="radio" value="뷰티관광" name="act" id="act">
            쇼핑 <input type="radio" value="쇼핑" name="act" id="act">
            스포츠활동 <input type="radio" value="스포츠활동" name="act" id="act">
            시찰 <input type="radio" value="시찰" name="act" id="act">
            시티투어버스이용 <input type="radio" value="시티투어버스이용" name="act" id="act">
            식도락관광 <input type="radio" value="식도락관광" name="act" id="act">
            업무수행 <input type="radio" value="업무수행" name="act" id="act">
            연수·교육·연구 <input type="radio" value="연수·교육·연구" name="act" id="act">
            유흥/오락 <input type="radio" value="유흥/오락" name="act" id="act">
            의료관광 <input type="radio" value="의료관광" name="act" id="act">
            자연경관감상 <input type="radio" value="자연경관감상" name="act" id="act">
            전통문화체험 <input type="radio" value="전통문화체험" name="act" id="act">
            휴양,휴식 <input type="radio" value="휴양,휴식" name="act" id="act"></td>
         </tr>
         <tr>
            <td colspan=2>
