	...
	<table style="width:20% ;position: absolute; right: 0px;" >
		...
		<div id="main">
			...
			<article id="Join" style="width:100%;">
				<form id="joinForm" action="JoinService.do?num=5" method="post" onsubmit="return false">
					<table style = "margin: 0px auto; text-align: center;">
						<tr>
					...
					<div class="bp-hs" id="demo-default">
						<div class="bp-hs_inner">
							...
							<div class="bp-hs_inner__item" data-transform="scale">
								<img src="SEOULIMAGE/F1.PNG" alt="Boompx Hero Slider 01" />
							</div>
							<div class="bp-hs_inner__item" data-transform="rotate">
								<img src="SEOULIMAGE/F2.PNG" alt="Boompx Hero Slider 02" />
							</div>
							<div class="bp-hs_inner__item" data-transform="rotate">
								<img src="SEOULIMAGE/F3.PNG" alt="Boompx Hero Slider 02" />
							</div>
							<div class="bp-hs_inner__item" data-transform="rotate">
								<img src="SEOULIMAGE/F4.PNG" alt="Boompx Hero Slider 03" />
							</div>
							<div class="bp-hs_inner__item">
								<img src="SEOULIMAGE/F5.PNG" alt="Boompx Hero Slider 04" />
							</div>
							<div class="bp-hs_inner__item">
								<img src="SEOULIMAGE/F6.PNG" alt="Boompx Hero Slider 04" />
							</div>
							<div class="bp-hs_inner__item">
								<img src="SEOULIMAGE/F7.PNG" alt="Boompx Hero Slider 04" />
							</div>
							<div class="bp-hs_inner__item">
								<img src="SEOULIMAGE/F8.PNG" alt="Boompx Hero Slider 04" />
							</div>
							<div class="bp-hs_inner__item">
								<img src="SEOULIMAGE/F9.PNG" alt="Boompx Hero Slider 04" />
							</div>
							<div class="bp-hs_inner__item">
								<img src="SEOULIMAGE/F10.PNG" alt="Boompx Hero Slider 04" />
							</div>
							<div class="bp-hs_inner__item">
								<img src="SEOULIMAGE/F11.PNG" alt="Boompx Hero Slider 04" />
							</div>
