	...
	<div id="wrapper" style="position: relative;">
		...
		<div id="lan" style="z-index: 9999;">
			...
			%>
					...
					<td class="inTag"><a href="LogoutService.do">Logout </a></td>
					<td class="inTag"><a href="update.jsp">ChangeInfo</a></td>
					<%
				}
			%>
...
<!-- 이 아래로는 모두 컨텐츠 내용 및 스크립트에 해당하는 내용 -->
	...
	<p id="texttext1">전화번호 : 02-3700-3900 주소 : 서울 종로구 사직로 161 경복궁 지번 :
		세종로 1-91 개장 시간 : 매일 09:00 - 18:00(입장마감 17:00) 화요일 휴무 대인(만25세~만64세) :
		3,000원 만24세 이하 청소년 : 무료 장애인, 유공자 : 무료 만65세 이상 어르신 : 무료 한복을 착용한 자 :무료
	...
	<p id="texttext2">주소 : 서울 중구 명동 대한민국에서 가장 비싼 땅인 명동은 서울특별시를 상징하는
		번화가이다. 조선 시대에는 주택가였으나 일제강점기 충무로가 상업지역으로 발전하며 인접지역인 명동도 상가형태로 변하게 되어
		대한민국 최고의 번화가로 발돋움 하게 되었다. 명동은 유행의 선도자라고 불릴 정도로 거대한 쇼핑 문화가 형성되어 잇는데, 국내
		유명 백화점은 물론 명품,브랜드 매장뿐 만아니라 보세가게까지 다양한 상점이 있어 쇼핑에 최적화 되있다고 말할 수 있다. 또한
		명동에는 쇼핑과 함께 먹을거리,즐길거리 등이 있어 내국인 뿐만아니라 외국인들도 한국에서 즐길 수 있는 최적의 공간이라 불릴수
		있다.~</p>
	<p id="texttext3">주소 : 서울 종로구 인사동 인사동 쌈지길은 서울시 종로구 인사동 내에 있는 건물을
		말한다. 쌈지란 '주머니'를 뜻하는 순우리말이다. 쌈지길은 '쌈지' 뒤에 '길'을 붙여 인사동 골목에 여러 문화적 재미요소를
		더한다는 뜻을 지녔다.쌈지길은 가아 건축 연구소 최문규 건축가가 (주)쌈지의 권유로 만든 건물이다. 쌈지길은 공예품전문
		쇼핑몰로서 인사동에 관광명소가 되고 있다. 연면적 4,066.01m²(1,200여평)의 나선형 건물에 한국의 전통공예품 혹은
	...
	<p id="texttext4">전화번호 : 02-6000-0114 주소 : 서울 강남구 영동대로 513 지번 : 삼성동
		159 개장 시간 : 매일 10:00 - 18:00비고(행사 종료시간 상이) 교통과 통신, 첨단 비즈니스 인프라를 두루 갖춘
		글로벌 비즈니스의 메카이자 아시아 최고의 전시·문화·관광의 명소로서,국제 무역과 문화 교류의 장을 마련할 목적으로 1979년
	...
	<p id="texttext5">전화번호 : 02-3668-2300 주소 : 서울 종로구 율곡로 99 지번 : 와룡동
		2-71 개장시간 : 매일 09:00 - 18:00(2월~5월, 9월~10월) , 매일 09:00 - 18:30(6월~8월)
		, 매일 09:00 - 16:30(11월~1월) 월요일 휴무 창덕궁은 서울시 종로구에 위치한 조선 시대의 궁궐이다. 건축과
		조경이 잘 조화된 종합 환경디자인 사례이면서 동시에 한국적인 공간 분위기를 읽게 하는 중요한 문화유산이다. 건축사에 있어 조선
		시대 궁궐의 한 전형을 보여 주며, 후원의 조경은 우리나라의 대표적인 왕실 정원으로서 가치가 높다창덕궁은 불행한 역사 속에서
	...
	<p id="texttext6">전화번호 : 02-3218-4800 주소 : 서울 강남구 봉은사로 531 봉은사 지번 :
		삼성동 73 봉은사는 평일과 휴일이 없이 언제나 기도하고 참배하는 사람들로 넘쳐 여느 절같지 않게 조금 낯설다. 종교가 일상과
	...
	<p id="texttext7">전화번호 : 1833-7001 주소 : 서울 영등포구 63로 50 한화금융센터_63
		지번:여의도동 60 한화금융센터_63 개장 시간 : 매일 10:00 - 22:00 요금 : 63아트_성인(20세 이상) :
		20,000원 63아트_어린이(13세 이하) : 16,000원 63아트_청소년(14 - 19세) : 18,000원 63아트
		커플권(63아트 2인/아메리카노2잔) : 43,000원 아쿠아플라넷63(20세이상) : 25,000원 롯데 타워가 완공
		되기전까지 서울을 대표하는 한국에서 가장 높은 건물 이었던 63빌딩은 대한민국 기업 '한화'가 1985년에 완공한 서울을
	...
	<p id="texttext8">전화번호 : 02-709-3139 주소 : 서울 용산구 이태원로 29 전쟁기념관 지번 :
		용산동1가 8 전쟁기념관 개장시간 : 매일 09:30 - 18:00 월요일 휴무(월요일이 포함된 연휴때는 연휴 다음날 휴관)
	...
	<p id="texttext9">전화번호 : 02-2133-1372 주소 : 서울 종로구 계동길 37 지번 : 계동
		105 북촌문화센터 경복궁과 창덕궁, 금원(비원) 사이 북악산 기슭에 있는 한옥 보존지구로 청계천과 종로의 윗동네라는 뜻으로
		...
		느껴 보는건 어떠한가?</p>
	<p id="texttext10">전화번호 : 02-2077-9000 주소 : 서울 용산구 서빙고로 137 지번 :
		용산동6가 168-6 개장시간 : 월,화,목,금 10:00 - 18:00 , 수,토 10:00 - 21:00 , (일요일,
		공휴일) 10:00 - 19:00 휴무 : 1월1일,설날,추석날 / 상설전시실 휴실 : 4,11월 첫째 월요일 관람료 : 무료
