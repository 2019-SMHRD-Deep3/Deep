		...
		<article id="Join">
			<form action = "JoinService.do" method = "post">
				<table>
					...
					<tr>
						<td>비밀번호</td>
						<td colspan=2><input placeholder="비밀번호 입력 " type="password" name=pw></td>
					</tr>
					<tr>
						<td>비밀번호 확인</td>
						<td colspan=2><input placeholder="비밀번호 재입력 " type="password" name=pw></td>
					</tr>
					<tr>
						<td>이름</td>
						<td colspan=2><input placeholder="전화번호 입력 " type="text" name=name></td>
					</tr>
					<tr>
						<td>이메일</td>
						<td colspan=2><input placeholder="이메일 입력 " type="text" name=email></td>
					</tr>
					<tr>
						<td></td>
			...
			<article id="intro">
				...
				<p>서울특별시는 대한민국의 수도이자 최대 도시입니다. 한반도 중앙에 있으며, 한강을 사이에 두고 남북으로 펼쳐져
					있다. 북쪽 끝은 도봉구 도봉동, 동쪽 끝은 강동구 상일동, 남쪽 끝은 서초구 원지동, 서쪽 끝은 강서구 오곡동이다.
					시청은 중구 을지로1가(태평로1가 31)에 있다. 한반도의 0.28%(남한 면적의 0.61%)에 해당하는 넓이로, 남북간
					연장거리 30.30km, 동서간 연장거리 36.78km이다. 1394년(태조 3)부터 한국의 수도가 되어
					정치·경제·산업·사회·문화·교통의 중심지가 되어 왔다. 1960년대 이후 경제발전과 함께 도시화가 진행되면서 통근 및
					거주지역이 반경 30km 내의 주변 수도권에 광역적으로 확장되고 있어, 거대도시(Megalopolis)가 되고 있다.
					서울 정도(定都) 600년인 1994년에 10월 28일이 서울시민의 날로 제정되어 이후 각종 행사가 열리고 있다.
					1988년 국제올림픽이 열렸고, 2010년 G20, 2012년 핵안보정상회의가 열렸다.</p>
