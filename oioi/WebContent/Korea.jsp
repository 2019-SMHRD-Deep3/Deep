...
print 'It took ' + i + ' iterations to sort the deck.';</code>
	...
	<p id="texttext2">대한민국에서 가장 비싼 땅인 명동은 서울특별시를 상징하는 번화가이다. 조선 시대에는
		...
		매장뿐 만아니라 보세가게까지 다양한 상점이 있어 쇼핑에 최적화 되있다고 말할 수 있다. 또한 명동에는 쇼핑과 함게
		먹을거리,즐길거리 등이 있어 내국인 뿐만아니라 외국인들도 한국에서 즐길 수 있는 최적의 공간이라 불릴수 있다.~</p>
	<p id="texttext3">인사동 쌈지길은 서울시 종로구 인사동 내에 있는 건물을 말한다. 쌈지란 '주머니'를
	...
	<p id="texttext4">교통과 통신, 첨단 비즈니스 인프라를 두루 갖춘 글로벌 비즈니스의 메카이자 아시아 최고의
	...
	<p id="texttext5">창덕궁은 서울시 종로구에 위치한 조선 시대의 궁궐이다. 건축과 조경이 잘 조화된 종합
	...
	<p id="texttext6">봉은사는 평일과 휴일이 없이 언제나 기도하고 참배하는 사람들로 넘쳐 여느 절같지 않게
	...
	<p id="texttext7">롯데 타워가 완공 되기 전까지 서울을 대표하는 한국에서 가장 높은 건물 이었던 63빌딩은
		대한민국 기업 '한화'가 1985년에 완공한 서울을 대표하는 랜드마크로 자리잡았다. 당시, 고층 빌딩이 없던 한국에 한화라는
		기업이 수익의 목적이 아닌 회사건물을 목적으로 건축 했으나 대한민국의 랜드마크라는 타이틀까지 두마리 토끼를 한번에 잡은
		케이스가 되기도 하였다. 롯데 타워와 다르게 한화와 다른 기업들의 사무실등이 있고 각종 부대시설과 전망대, 지하에는 수족관
		까지 초고층건물의 이점을 상술에 이용한 관광공간을 마련한 점이 특징이다. 여의도에 있는 63빌딩은 전망대를 통해 서울
		정중앙에서 제일 높은 전망대에서 서울을 전부 둘러 볼 수 있어 아직도 많은 관광객들이 찾는 서울에 랜드마크중 한곳이라고 한다.</p>
	<p id="texttext8">1950년 6월25일, 아직 동이 트기 전 모두가 잠든 새벽. 평화로운 한반도에 총성이
	...
	<p id="texttext9">경복궁과 창덕궁, 금원(비원) 사이 북악산 기슭에 있는 한옥 보존지구로 청계천과 종로의
		...
		느껴 보는건 어떠한가?</p>
	<p id="texttext10">우리 역사의 소중한 유물들이 멋진 새 보금자리를 찾았다. 2005년 10월 개관한
