...
<div id="wrapper" position=relative;>
	...
	<table style="width:20%; position: absolute; right: 0px;" >
		...
		<div id="main">
			...
			<article id="about">
				...
				<div class = "">
				<span><img id="popimg2" src="img/k1.PNG" alt="" /></span>
	...
	<p id="texttext1">전화번호 : 02-3700-3900
		...
		주소 : 서울 종로구 사직로 161 경복궁  지번 : 세종로 1-91 

		개장 시간 : 매일 09:00 - 18:00(입장마감 17:00) 화요일 휴무

		대인(만25세~만64세) : 3,000원

		만24세 이하 청소년 : 무료  장애인, 유공자 : 무료

		만65세 이상 어르신 : 무료  한복을 착용한 자 :무료

		경복궁은 대한민국을 대표하는 가장 큰 궁궐로 조선왕조의 번영에 큰 도움을 주었다.
	...
	<p id="texttext2">주소 : 서울 중구 명동
		...
		대한민국에서 가장 비싼 땅인 명동은 서울특별시를 상징하는 번화가이다. 조선 시대에는
		...
		매장뿐 만아니라 보세가게까지 다양한 상점이 있어 쇼핑에 최적화 되있다고 말할 수 있다. 또한 명동에는 쇼핑과 함께
		먹을거리,즐길거리 등이 있어 내국인 뿐만아니라 외국인들도 한국에서 즐길 수 있는 최적의 공간이라 불릴수 있다.~</p>
	<p id="texttext3">주소 : 서울 종로구 인사동
		
		인사동 쌈지길은 서울시 종로구 인사동 내에 있는 건물을 말한다. 쌈지란 '주머니'를
		뜻하는 순우리말이다. 쌈지길은 '쌈지' 뒤에 '길'을 붙여 인사동 골목에 여러 문화적 재미요소를 더한다는 뜻을 지녔다.쌈지길은
		가아 건축 연구소 최문규 건축가가 (주)쌈지의 권유로 만든 건물이다. 쌈지길은 공예품전문 쇼핑몰로서 인사동에 관광명소가 되고
		있다. 연면적 4,066.01m²(1,200여평)의 나선형 건물에 한국의 전통공예품 혹은 한국의 멋이 풍기는 다양한 디자인의
		70여개의 공예품점, 문화상품과 기념품가게, 갤러리, 음식점들이 모여있어 관광객들에게 다양한 즐길거리를 제공한다.
		건물에‘길’이 붙은 것은 4층 전체가 하나의 골목으로 연결됐기 때문이다. 마름모꼴의 마당을 둘러싼‘ㅁ’자 형태다. 각 층은
		완만한 경사로로 이어져 이곳저곳 가게를 구경하며 걷다보면 옥상의 하늘정원에 다다른다.또한 쌈지길은 인사동길에 면해 있던'열두
		가게' 를 그대로 유지함으로써 인사동길의 성격을 살리는 동시에, 건물 내부에 마당과 오름길을 통해 인사동의 성격을 살림으로써,
		창의적 재해석과 전통의 진화를 성공적으로 해석해냈다</p>
	<p id="texttext4">전화번호 : 02-6000-0114
		...
		교통과 통신, 첨단 비즈니스 인프라를 두루 갖춘 글로벌 비즈니스의 메카이자 아시아 최고의
		전시·문화·관광의 명소로서,국제 무역과 문화 교류의 장을 마련할 목적으로 1979년 3월 개관한 한국 최대의 종합전시관이다.
		총 1만 1000평(연면적 13만여 평)규모로,지상 4층,지하 4층으로 이루어져 있으며, 12개의 전문 전시실과 7000명을
		동시에 수용할 수 있는 컨벤션홀을 비롯해 61개의 회의실을 갖추고 있다. 또 국제 비즈니스를 위한 종합적인 지원체제를 갖추고
		연간 150여 회의 전문 전시회,각종 국제회의와 이벤트를 개최하는 한편, 해외 유수의 바이어와 국내 수출입업체를 직접
		연결시키는 등 교역 증대 역할도 한다.또한 코엑스내 아쿠아리움이 있어 한국인관광객 뿐만 아니라 외국인 관광객들도 도심 속에서
		큰 규모에 아쿠아리움을 구경할 수 있다.</p>
	<p id="texttext5">전화번호 : 02-3668-2300

		주소 : 서울 종로구 율곡로 99 지번 : 와룡동 2-71

		개장시간 : 매일 09:00 - 18:00(2월~5월, 9월~10월) , 매일 09:00 - 18:30(6월~8월) , 매일 09:00 - 16:30(11월~1월)
		월요일 휴무


		창덕궁은 서울시 종로구에 위치한 조선 시대의 궁궐이다. 건축과 조경이 잘 조화된 종합
		환경디자인 사례이면서 동시에 한국적인 공간 분위기를 읽게 하는 중요한 문화유산이다. 건축사에 있어 조선 시대 궁궐의 한 전형을
		보여 주며, 후원의 조경은 우리나라의 대표적인 왕실 정원으로서 가치가 높다창덕궁은 불행한 역사 속에서 탄생한 조선의 궁궐이라고
		불리우는데,조선을 건국한 이성계의 아들들과 신하들 사이에서 권려 다툼이 벌어져 왕위 다툼을 하던중 왕이 되었던 다섯째 아들이
		왕이되었으나 형제들을 죽였던 경복궁으로 들어가는것을 싫어했던 태종은 새로운 궁궐을 지어 집무를 보았는데, 그 궁궐이
		창덕궁이다. 아픈 역사를 지닌 만큼 특별하고 볼 것이 많은 조선을 대표하는 대한민국을 대표하는 궁궐이다.</p>
	<p id="texttext6">전화번호 : 02-3218-4800

		주소 : 서울 강남구 봉은사로 531 봉은사 지번 : 삼성동 73
		
		봉은사는 평일과 휴일이 없이 언제나 기도하고 참배하는 사람들로 넘쳐 여느 절같지 않게
		조금 낯설다. 종교가 일상과 밀접하게 만나는 현장이라 할 수 있으나 차분하게 절을 돌아보고자 하는 사람들에게는 그리 좋지 않는
		것도 사실이다. 항상 많은 사람들이 기도하는 곳이다 보니 시설이나 공간이 늘어나야 해서 항상 봉은사는 공사중이라고 한다.
		봉은사는 신라 우너성왕 때 창건한 절로 조선 중종의 왕비 정현황후의 묘가 생겨 조선 왕실의 관심을 받고 발전하는 사찰이 되기
		시작하였다. 흔히 우리가 아는 절은 사람들이 살지 않는 산이나 일반 시민들의 생활반경 밖에 있는것이 많은데 봉은사는 서울
		한가운데, 그것도 강남이라는 서울에서 제일 유동인구가 많은 정중앙에 위치해 종교인들의 왕래가 많은것은 물론, 교통과 접근이
		편리해 많은 외국인 종교인들도 한번씩은 들러가는 대한민국을 대표하는 사찰이 되었다.</p>
	<p id="texttext7">전화번호 : 1833-7001
		...
		요금 : 63아트_성인(20세 이상) : 20,000원 63아트_어린이(13세 이하) : 16,000원

		63아트_청소년(14 - 19세) : 18,000원 63아트 커플권(63아트 2인/아메리카노2잔) : 43,000원

		아쿠아플라넷63(20세이상) : 25,000원 

		롯데 타워가 완공 되기전까지 서울을 대표하는 한국에서 가장 높은 건물 이었던 63빌딩은 대한민국 기업 '한화'가 1985년에 완공한 서울을 대표하는 랜드마크로 자리잡았다. 당시, 고층 빌딩이 없던 한국에 한화라는 기업이 수익의 목적이 아닌 회사건물을 목적으로 건축 했으나
		대한민국의 랜드마크라는 타이틀까지 두마리 토끼를 한번에 잡은 케이스가 되기도 하였다. 롯데 타워와 다르게 한화와 다른 기업들의
		사무실등이 있고 각종 부대시설과 전망대, 지하에는 수족관 까지 초고층건물의 이점을 상술에 이용한 관광공간을 마련한 점이
		특징이다. 여의도에 있는 63빌딩은 전망대를 통해 서울 정중앙에서 제일 높은 전망대에서 서울을 전부 둘러 볼 수 있어 아직도
		많은 관광객들이 찾는 서울에 랜드마크중 한곳이라고 한다.
	...
	<p id="texttext8">전화번호 : 02-709-3139
		...
		1950년 6월25일, 아직 동이 트기 전 모두가 잠든 새벽. 평화로운 한반도에 총성이
		울려퍼졌다. 북한군이 남북 군사분계선이던 38선을 넘어 남침하면서 시작된 6·25전쟁. 피를 나눈 한민족끼리의 전쟁은
		미국·소련·중국의 개입으로 1953년 7월 휴전협정 때까지 수많은 사상자를 내며 계속됐다. 일제강점기에서 벗어난 기쁨을 채
		누리기도 전이었다. 반세기 전, 이 땅에서 벌어졌던 역사를 기록한 용산의 전쟁기념관을 소개한다. 전쟁 기념관은 1층 전쟁역사실
		2층 6.25전쟁실을 관람 하게 된다.항상 하루에 2차례 문화해설사의 동행 관람을 통해 우리가 잘 알지 못했던 역사에 대해
		조금 더 자세하게, 생생하게 설명을 들을 수 있는 장점이 있다. 또한 전쟁역사실에서 지금까지의 한반도의 전쟁 역사를 한번에
		확인할 수 있다. 전쟁 기념관은 남.북으로 나눠져 있는 한반도 상황을 잘 알고 있는 독일인들에게 인기라고 한다. 전쟁기념관을
		통해서 우리가 잊고 있던 전쟁역사를 다시한번 느껴보는 것도 좋은 방법이라고 생각한다.</p>
	<p id="texttext9">전화번호 : 02-2133-1372

		주소 : 서울 종로구 계동길 37 지번 : 계동 105 북촌문화센터

		경복궁과 창덕궁, 금원(비원) 사이 북악산 기슭에 있는 한옥 보존지구로 청계천과 종로의
		윗동네라는 뜻으로 북촌이라고도 한다. 북촌은 고관대작들과 왕족, 사대부들이 모여서 거주해온 고급 살림집터로 한옥은 모두
		조선시대의 기와집이다. 원래 이 지역에는 솟을대문이 있는 집 몇 채와 30여 호의 한옥만이 있었으나 일제강점기 말부터 한옥이
		많이 지어졌고, 1992년 가회동한옥보존지구에서 해제되고, 1994년 고도제한이 풀리면서 일반 건물들이 많이 들어섰다. 총
		2,297동의 건물이 있는데, 이 가운데 1,408동이 한옥이고 나머지는 일반 건물이다. 북촌 거리에는 북촌양반생활문화전시관과
		북촌 한옥촌 상징조형물이 설치되어 있으며, 옛 선조의 생활모습을 구경할 수 있는 가회동 전통 마을축제가 열린다. 주변에
	...
	<p id="texttext10">전화번호 : 02-2077-9000
		...
		휴무 : 1월1일,설날,추석날 / 상설전시실 휴실 : 4,11월 첫째 월요일
